...
public class InvitationCampaignView {
    ...
    public Integer getNumberOfInfluencers() {
        return numberOfInfluencers;
    }

    public void setNumberOfInfluencers(Integer numberOfInfluencers) {
