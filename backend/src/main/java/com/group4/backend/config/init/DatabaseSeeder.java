...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    // Seed rates per influencer (USD)
    private static final double RATE_GAMER_TAYLOR  = 5000.0;
    private static final double RATE_GAMER_JORDAN  = 1500.0;
    private static final double RATE_GAMER_ALEX    = 4000.0;
    private static final double RATE_TECH_SAM      = 10000.0;
    private static final double RATE_TECH_MORGAN   = 2000.0;
    private static final double RATE_TECH_RILEY    = 7500.0;
    private static final double RATE_FITNESS_CASEY = 3500.0;
    private static final double RATE_FITNESS_AVERY = 1800.0;
    private static final double RATE_FITNESS_DREW  = 3000.0;
    private static final double RATE_FASHION_BLAKE = 8000.0;
    private static final double RATE_FASHION_JAMIE = 4000.0;
    private static final double RATE_FASHION_ROBIN = 1500.0;
    ...
    private static List<MockInfluencer> buildMockInfluencers() {
        return Arrays.asList(
            new MockInfluencer("gamer1@test.com", "Taylor", "Gaming",
                ...
                "1.2M YouTube, 500k Twitch", RATE_GAMER_TAYLOR, "https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=200&h=200&fit=crop"),
            new MockInfluencer("gamer2@test.com", "Jordan (Retro)", "Gaming",
                "Retro gaming console collector and passionate streamer.", "Austin, TX",
                "300k Twitch", RATE_GAMER_JORDAN, "https://images.unsplash.com/photo-1548681528-6a5c45b66b42?q=80&w=200&h=200&fit=crop"),
            new MockInfluencer("gamer3@test.com", "Alex FPS", "Gaming",
                "Competitive FPS player ranking top 10 globally.", "Los Angeles, CA",
                "800k TikTok, 2M YouTube", RATE_GAMER_ALEX, "https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=200&h=200&fit=crop"),
            new MockInfluencer("tech1@test.com", "Sam Gadgets", "Technology",
                "Unboxing the newest smartphones and wearables.", "San Francisco, CA",
                "3M YouTube", RATE_TECH_SAM, "https://images.unsplash.com/photo-1527980965255-d3b416303d12?q=80&w=200&h=200&fit=crop"),
            new MockInfluencer("tech2@test.com", "Morgan Codes", "Technology",
                ...
                "400k Instagram, 100k Twitter", RATE_TECH_MORGAN, "https://images.unsplash.com/photo-1554151228-14d9def656e4?q=80&w=200&h=200&fit=crop"),
            new MockInfluencer("tech3@test.com", "Riley AI", "Technology",
                ...
                "1.5M YouTube, 900k TikTok", RATE_TECH_RILEY, "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=200&h=200&fit=crop"),
            new MockInfluencer("fit1@test.com", "Casey Lifts", "Fitness",
                "Powerlifting coach and nutrition expert.", "Denver, CO",
                "1M Instagram", RATE_FITNESS_CASEY, "https://images.unsplash.com/photo-1517849845537-4d257902454a?q=80&w=200&h=200&fit=crop"),
            new MockInfluencer("fit2@test.com", "Avery Yoga", "Fitness",
                "Mindful living and advanced Yoga practitioner.", "San Diego, CA",
                "500k TikTok", RATE_FITNESS_AVERY, "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=200&h=200&fit=crop"),
            new MockInfluencer("fit3@test.com", "Drew Runner", "Fitness",
                ...
                "850k YouTube", RATE_FITNESS_DREW, "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&h=200&fit=crop"),
            new MockInfluencer("style1@test.com", "Blake Couture", "Fashion",
                "High-end fashion editorial photographer and model.", "Paris, FR",
                "2.2M Instagram", RATE_FASHION_BLAKE, "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?q=80&w=200&h=200&fit=crop"),
            new MockInfluencer("style2@test.com", "Jamie Streetwear", "Fashion",
                "Urban fashion trends, sneaker collector.", "Tokyo, JP",
                "1.1M TikTok", RATE_FASHION_JAMIE, "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?q=80&w=200&h=200&fit=crop"),
            new MockInfluencer("style3@test.com", "Robin Vintage", "Fashion",
                "Thrifting and sustainable vintage style enthusiast.", "Portland, OR",
                "450k Instagram", RATE_FASHION_ROBIN, "https://images.unsplash.com/photo-1513379733131-47fc74b45fc7?q=80&w=200&h=200&fit=crop")
        );
    }
